...
키워드 문자를 받으면 발신자에게 기기의 현재 위치를 회신해요. 회신 문자의 링크를 열면 지도에서 위치를 바로 확인할 수 있어요.

| 위치 회신 문자 | 지도에서 위치 확인 |
| --- | --- |
| <img src="resource/screen-received.png" width="200"> | <img src="resource/screen-map.png" width="200"> |
